...
function getTodo (req, res) { // Función basada en el video-tutorial: https://www.youtube.com/watch?v=IQR6sZhoZ24&list=PLUdlARNXMVkk7E88zOrphPyGdS50Tadlr&index=9
...
function getTodos(req, res) { // Función basada en el video-tutorial: https://www.youtube.com/watch?v=IQR6sZhoZ24&list=PLUdlARNXMVkk7E88zOrphPyGdS50Tadlr&index=9
  Todo.find({}, (err, todos) => {
    if (err)  return res.status(500).send({message: `Error al realizar la peticion: ${err}`})
...
function saveTodo(req, res){ // Función basada en el video-tutorial: youtube.com/watch?v=2246l6G-1GI&list=PLUdlARNXMVkk7E88zOrphPyGdS50Tadlr&index=8
...
function updateTodo (req, res) { // Función basada en el video-tutorial: https://www.youtube.com/watch?v=CjOMThGjiMo&list=PLUdlARNXMVkk7E88zOrphPyGdS50Tadlr&index=10
  let todoId = req.params.todoId
  let update = req.body
...
function updateCompletado (req,res) { // Función basada en el video-tutorial: https://www.youtube.com/watch?v=CjOMThGjiMo&list=PLUdlARNXMVkk7E88zOrphPyGdS50Tadlr&index=10
  let todoId = req.params.todoId
  let update = req.body
    Todo.findByIdAndUpdate (todoId, update, {new:true}, (err,todoUpdated) => {
...
function deleteTodo (req, res) { // Función basada en el video-tutorial: https://www.youtube.com/watch?v=CjOMThGjiMo&list=PLUdlARNXMVkk7E88zOrphPyGdS50Tadlr&index=10
  let todoId = req.params.todoId
...
function getListas(req, res) { // Función basada en el video-tutorial: https://www.youtube.com/watch?v=IQR6sZhoZ24&list=PLUdlARNXMVkk7E88zOrphPyGdS50Tadlr&index=9
...
function getTodosLista (req, res) { //Función basada en el video-tutorial: https://www.youtube.com/watch?v=IQR6sZhoZ24&list=PLUdlARNXMVkk7E88zOrphPyGdS50Tadlr&index=9
...
function saveLista(req, res){ // Función basada en el video-tutorial: https://www.youtube.com/watch?v=2246l6G-1GI&list=PLUdlARNXMVkk7E88zOrphPyGdS50Tadlr&index=8
...
function deleteLista (req, res) { //Función basada en el video-tutorial: https://www.youtube.com/watch?v=CjOMThGjiMo&list=PLUdlARNXMVkk7E88zOrphPyGdS50Tadlr&index=10
